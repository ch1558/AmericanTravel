...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/template/hamburgers.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/template/animsition.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/template/select2.min.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ asset('css/template/daterangepicker.css') }}">
...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="{{ route('dashboard') }}" class="login100-form validate-form">
					@csrf
					...
					<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Escribe tu correo electrónico">
						<input id="first-name" class="input100" type="text" name="email" placeholder="Correo electrónico" value="{{ old('email') }}">
    ...
    <script src="{{ asset('js/template/animsition.min.js') }}"></script>
    ...
    <script src="{{ asset('js/template/countdowntime.js') }}"></script>
    <script src="{{ asset('js/template/login.js') }}"></script>

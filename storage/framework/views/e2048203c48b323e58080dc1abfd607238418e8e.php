                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="card-category"><?php echo e($title[1]); ?></p>
                        </div>
                        
                        <div class="card-body">
                            <img class="featurette-image img-fluid mx-auto" src="<?php echo e(asset($image)); ?>" style="align-content: center;" alt="atiimage" style="width: 250px; height: 250px;" data-holder-rendered="true">
                            <br><br>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php for($i=0; $i< sizeof($comments) ; $i++): ?>
                                ...
                                <tr>
                                    <td><?php echo e($comments[$i]->informative_name); ?></td>
                                    <td><?php echo e($comments[$i]->informative_subname); ?></td>
                                    <td><?php echo e($comments[$i]->informative_description); ?></td>
                                    <td><img class="featurette-image img-fluid mx-auto" src="<?php echo e(asset($photo)); ?>" style="align-content: center; width: 70px !important; height: 70px!important;" alt="ati.image" data-holder-rendered="true"></td>
        ...
        <div class="row">
            <?php for($i=0; $i < sizeof($segundarios); $i++): ?>
                ...
                <div class="col-md-3">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title" style="text-align:center;"><?php echo e($segundarios[$i]->service_name); ?></h5>
                        </div>
                        
                        <div class="card-body">
                            <div class="mx-auto" style="width:64px">
                                <img class="featurette-image img-fluid mx-auto" src="<?php echo e(asset($image)); ?>" alt="atiimage" style="width: 64px; height: 64px;" data-holder-rendered="true">
                            </div>
                            <br><br>
                            <p style="text-align:justify; font-size:15px;"><?php echo e($segundarios[$i]->service_description); ?></p>
                        <div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            ?>
                            <div class="mx-auto">
                                <img class="featurette-image img-fluid mx-auto" style="height: 120px;" src="<?php echo e(asset($image)); ?>" alt="atiimage" data-holder-rendered="true">
                            </div>
                            <h4>Información de contacto</h4>
                            <ul class="colorlib-footer-links">
                                <li><?php echo e($contacto->contact_location); ?></li>
                                <?php 
                                    $numbers = explode('(+57)',$contacto->contact_phone);
                                ?>
                                <?php for($i=1; $i < sizeof($numbers); $i++): ?>
                                    <li>(+57) <?php echo e($numbers[$i]); ?></li>
                                <?php endfor; ?>
                                <li><?php echo e($contacto->contact_email); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\AmericanTravel\resources\views/sgi/page.blade.php ENDPATH**/ ?>
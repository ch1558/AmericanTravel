    ...
    <div id="page">
        ...
        <aside id="colorlib-hero">
            <div class="flexslider">
                <ul class="slides">
                    <li style="background-image: url(<?php echo e(asset('image/poli.jpg')); ?>);">
            ...
            <div class="row">
                ...
                <!--Ubicacion -->
                    ...
                    <p style="text-align: justify; font-size: 16px;">American travel internacional se encuentra ubicada en 
                        <?php echo e($contacto->contact_location); ?>; y tiene dispuestos como canales de contacto con sus clientes,
                        ...
                        <?php for($i=1; $i < sizeof($numbers); $i++): ?>
                            (+57) <?php echo e($numbers[$i]); ?>

                            <?php if($i+1< sizeof($numbers)): ?> - <?php endif; ?>
                        <?php endfor; ?>
                    </p>
                <!-- fin ubicacion -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\AmericanTravel\resources\views/privacity.blade.php ENDPATH**/ ?>